...
/*
find_fibonacci_between: find Fibonacci numbers between two integers, using 
    the rule that if x is a Fibonacci number, then either 5x^2\pm4 
    must be a perfect square.

    Arguments:  
    vector<int> vect:   passed by reference, contains results
    int x, y:           intergers   
*/
...
int main() {
    ...
    found = false;
    // find valid sequences which starts with current_n, starting with max n. 
